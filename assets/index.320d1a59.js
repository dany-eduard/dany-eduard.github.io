import{j as y,s as n,r as v,W as z,R as E,a as S}from"./vendor.8e1174a4.js";const j=function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))m(i);new MutationObserver(i=>{for(const t of i)if(t.type==="childList")for(const h of t.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&m(h)}).observe(document,{childList:!0,subtree:!0});function l(i){const t={};return i.integrity&&(t.integrity=i.integrity),i.referrerpolicy&&(t.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?t.credentials="include":i.crossorigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function m(i){if(i.ep)return;i.ep=!0;const t=l(i);fetch(i.href,t)}};j();var M="assets/logo.e7ef0941.svg",b="assets/menu.31757ce1.svg",w="assets/close.69d19444.svg";const e=y.exports.jsx,r=y.exports.jsxs,k=n.div`
  width: 100%;
  height: 70px;
...
`,F=n.div`
  display: none;
  @media (max-width: 960px) {
    background-image: url(${({open:o})=>o?w:b});
    display: flex;
    align-items: center;
    cursor: pointer;
    transition: 0.5s all ease;
  }
`,C=()=>{const[o,a]=v.exports.useState(!1);return e(k,{children:r(D,{children:[e(T,{children:e("img",{src:M,alt:"danyeduard-logo"})}),e(F,{open:o,onClick:()=>a(!o),children:o?e("img",{src:w,alt:"close-icon"}):e("img",{src:b,alt:"menu-icon"})}),r(A,{open:o,onClick:()=>a(!o),children:[e(s,{children:e(d,{href:"#about",children:"Sobre m\xED"})}),e(s,{children:e(d,{href:"#experience",children:"Experiencia"})}),e(s,{children:e(d,{href:"#projects",children:"Proyectos"})}),e(s,{children:e(d,{href:"#contact",children:"Hablame"})}),e(s,{children:e(d,{href:"https://drive.google.com/file/d/12BVXeru5dv3Gjlf08ffL1NiLWN0yVz2h/view?usp=sharing",target:"_blank",rel:"noopener noreferrer",className:"btn_resume",children:"Resume"})})]})]})})},p=n.section`
  width: 100%;
  height: 100%;
  display: flex;
  justify-content: center;
...
`,I=n.p`
  ...
  margin-top: 1rem;
  max-width: 560px;
`,N=()=>r(p,{children:[e(L,{children:"Hola, soy"}),r(W,{children:[e("h2",{children:"Daniel Eduardo."}),e("h2",{className:"descriptor",children:"Full-Stack Web Developer"})]}),e(I,{children:"Soy desarrollador web con experiencia en desarrollo Front-End y Back-End, con conocimientos en Node.js, React, Angular, Express, y muchas otras tecnolog\xEDas."})]}),f=n.h2`
...
`,U=()=>r(p,{children:[e(f,{id:"projects",children:"Proyectos"}),e(H,{children:e("h3",{children:"\u26A0 section under construction."})}),e(c,{})]});function $(){return r("div",{children:[e(C,{}),e(N,{}),e(B,{}),e(P,{}),e(U,{})]})}const G=z`
:root {
...
`;E.render(r(S.StrictMode,{children:[e(G,{}),e($,{})]}),document.getElementById("root"));
