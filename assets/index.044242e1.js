import{j as k,s as r,r as u,W as S,R as M,a as j}from"./vendor.8e1174a4.js";const L=function(){const l=document.createElement("link").relList;if(l&&l.supports&&l.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))f(t);new MutationObserver(t=>{for(const a of t)if(a.type==="childList")for(const x of a.addedNodes)x.tagName==="LINK"&&x.rel==="modulepreload"&&f(x)}).observe(document,{childList:!0,subtree:!0});function s(t){const a={};return t.integrity&&(a.integrity=t.integrity),t.referrerpolicy&&(a.referrerPolicy=t.referrerpolicy),t.crossorigin==="use-credentials"?a.credentials="include":t.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function f(t){if(t.ep)return;t.ep=!0;const a=s(t);fetch(t.href,a)}};L();var T="assets/logo.e7ef0941.svg",z="assets/menu.31757ce1.svg",E="assets/close.69d19444.svg";const A=`
  width: 100%;
  height: 70px;
...
`,e=k.exports.jsx,o=k.exports.jsxs,F=r.div`
  ${A}
`,W=r.div`
  ${C}
`,N=r.div`
...
`,R=r.div`
  display: none;
  @media (max-width: 960px) {
    background-image: url(${({open:n})=>n?E:z});
    display: flex;
    align-items: center;
    cursor: pointer;
    transition: 0.5s all ease;
  }
`,q=()=>{const[n,l]=u.exports.useState(!1);return e(F,{children:o(W,{children:[e(N,{children:e("img",{src:T,alt:"danyeduard-logo"})}),e(R,{open:n,onClick:()=>l(!n),children:n?e("img",{src:E,alt:"close-icon"}):e("img",{src:z,alt:"menu-icon"})}),o(P,{open:n,onClick:()=>l(!n),children:[e(c,{children:e(d,{href:"#about",children:"Sobre m\xED"})}),e(c,{children:e(d,{href:"#experience",children:"Experiencia"})}),e(c,{children:e(d,{href:"#projects",children:"Proyectos"})}),e(c,{children:e(d,{href:"#contact",children:"Hablame"})}),e(c,{children:e(d,{href:"https://drive.google.com/file/d/12BVXeru5dv3Gjlf08ffL1NiLWN0yVz2h/view?usp=sharing",target:"_blank",rel:"noopener noreferrer",className:"btn_resume",children:"Resume"})})]})]})})},m=r.section`
  width: 100%;
  display: flex;
  justify-content: center;
  flex-direction: column;
...
`,_=r.p`
  ...
  margin-top: 1rem;
  max-width: 560px;
`,H=()=>o(m,{children:[e(O,{children:"Hola, soy"}),o($,{children:[e("h2",{children:"Daniel Eduardo."}),e("h2",{className:"descriptor",children:"Back-End Developer"})]}),e(_,{children:"Soy desarrollador web con experiencia en desarrollo Front-End y Back-End, con conocimientos en Node.js, React, Angular, Express, y muchas otras tecnolog\xEDas."})]}),g=r.h2`
...
`,K=()=>o(m,{id:"projects",children:[e(g,{children:"Proyectos"}),e(X,{children:e("h3",{children:"\u26A0 section under construction."})}),e(i,{})]}),Y=r.div`
  font-size: clamp(var(--fz-xs), 8vw, var(--fz-xl));
  font-weight: 400;
  font-family: var(--code-fonts);
  color: var(--secondary-color);
...
`;r.div``;function fe(){return u.exports.useLayoutEffect(()=>{navigator.userAgent.match(/Android|BlackBerry|iPhone|iPad|iPod|Opera Mini|IEMobile/i)&&window.scrollTo(0,1)},[navigator.userAgent]),o(de,{children:[e(me,{children:e(q,{})}),o(he,{children:[e(H,{}),e(U,{}),e(V,{}),e(K,{}),e(re,{})]}),e(pe,{children:e(ce,{})})]})}const xe=S`
:root {
...
`;M.render(o(j.StrictMode,{children:[e(xe,{}),e(fe,{})]}),document.getElementById("root"));
