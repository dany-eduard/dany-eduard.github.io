import{j as y,s as r,r as w,W as E,R as S,a as j}from"./vendor.8e1174a4.js";const M=function(){const l=document.createElement("link").relList;if(l&&l.supports&&l.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))f(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const x of a.addedNodes)x.tagName==="LINK"&&x.rel==="modulepreload"&&f(x)}).observe(document,{childList:!0,subtree:!0});function s(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerpolicy&&(a.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?a.credentials="include":n.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function f(n){if(n.ep)return;n.ep=!0;const a=s(n);fetch(n.href,a)}};M();var T="assets/logo.e7ef0941.svg",z="assets/menu.31757ce1.svg",k="assets/close.69d19444.svg";const e=y.exports.jsx,o=y.exports.jsxs,D=r.div`
  width: 100%;
  height: 70px;
...
`,N=r.p`
  ...
  margin-top: 1rem;
  max-width: 560px;
`,R=()=>o(m,{children:[e(W,{children:"Hola, soy"}),o(B,{children:[e("h2",{children:"Daniel Eduardo."}),e("h2",{className:"descriptor",children:"Full-Stack Web Developer"})]}),e(N,{children:"Soy desarrollador web con experiencia en desarrollo Front-End y Back-End, con conocimientos en Node.js, React, Angular, Express, y muchas otras tecnolog\xEDas."})]}),u=r.h2`
...
`,U=()=>o(m,{id:"projects",children:[e(u,{children:"Proyectos"}),e(_,{children:e("h3",{children:"\u26A0 section under construction."})}),e(i,{})]}),$=r.div`
  font-size: clamp(var(--fz-xs), 8vw, var(--fz-xl));
  font-weight: 400;
  font-family: var(--code-fonts);
  color: var(--secondary-color);
...
`,Q=()=>o(m,{id:"contact",children:[e($,{children:"\xBFQu\xE9 es lo siguiente?"}),e(J,{children:e("h3",{children:"Contactame..."})}),e(i,{maxWidth:"632px",children:"Aunque actualmente no estoy buscando nuevas oportunidades, mi bandeja de entrada est\xE1 siempre abierta. Tanto si tienes una pregunta como si s\xF3lo quieres saludar, har\xE9 lo posible por responderte."})]});var V="assets/github.a236bd5f.svg",X="assets/gmail.9761f69e.svg",K="assets/linkedin.80b50059.svg",Y="assets/twitter.0346fa34.svg",Z="assets/whatsapp.bd86f9f0.svg";const ee=r.aside`
  display: flex;
...
`,oe=()=>e(ee,{children:o(re,{children:[e(p,{children:e("a",{href:"https://github.com/dany-eduard",target:"_blank",rel:"noopener noreferrer",children:e(h,{src:V,alt:"GitHub"})})}),e(p,{children:e("a",{href:"mailto:danyeduard17@gmail.com",target:"_blank",rel:"noopener noreferrer",children:e(h,{src:X,alt:"Gmail"})})}),e(p,{children:e("a",{href:"https://www.linkedin.com/in/dany-eduard/",target:"_blank",rel:"noopener noreferrer",children:e(h,{src:K,alt:"LinkedIn"})})}),e(p,{children:e("a",{href:"https://twitter.com/dany_eduard17",target:"_blank",rel:"noopener noreferrer",children:e(h,{src:Y,alt:"Twitter"})})}),e(p,{children:e("a",{href:"https://wa.link/1bdf5b",target:"_blank",rel:"noopener noreferrer",children:e(h,{src:Z,alt:"WhatsApp"})})})]})}),te=r.div`
  display: grid;
...
`;r.div``;function le(){return o(te,{children:[e(ne,{children:e(F,{})}),o(ie,{children:[e(R,{}),e(O,{}),e(G,{}),e(U,{}),e(Q,{})]}),e(ae,{children:e(oe,{})})]})}const se=E`
:root {
...
`;S.render(o(j.StrictMode,{children:[e(se,{}),e(le,{})]}),document.getElementById("root"));
