import{j as y,s as o,r as v,W as z,R as E,a as S}from"./vendor.8e1174a4.js";const j=function(){const c=document.createElement("link").relList;if(c&&c.supports&&c.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))p(i);new MutationObserver(i=>{for(const t of i)if(t.type==="childList")for(const h of t.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&p(h)}).observe(document,{childList:!0,subtree:!0});function l(i){const t={};return i.integrity&&(t.integrity=i.integrity),i.referrerpolicy&&(t.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?t.credentials="include":i.crossorigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function p(i){if(i.ep)return;i.ep=!0;const t=l(i);fetch(i.href,t)}};j();var M="assets/logo.e7ef0941.svg",b="assets/menu.31757ce1.svg",w="assets/close.69d19444.svg";const e=y.exports.jsx,r=y.exports.jsxs,k=o.div`
  width: 100%;
  height: 70px;
...
`,U=()=>r(m,{children:[e(f,{id:"projects",children:"Proyectos"}),e(H,{children:e("h3",{children:"\u26A0 section under construction."})}),e(a,{})]}),$=o.div`
  font-size: clamp(var(--fz-xs), 8vw, var(--fz-xl));
  font-weight: 400;
  font-family: var(--code-fonts);
  color: var(--secondary-color);
...
`,J=()=>r(m,{children:[e($,{children:"\xBFQu\xE9 es lo siguiente?"}),e(G,{children:e("h3",{id:"contact",children:"Contactame..."})}),e(a,{maxWidth:"632px",children:"Aunque actualmente no estoy buscando nuevas oportunidades, mi bandeja de entrada est\xE1 siempre abierta. Tanto si tienes una pregunta como si s\xF3lo quieres saludar, har\xE9 lo posible por responderte."})]});function Q(){return r("div",{children:[e(C,{}),e(N,{}),e(R,{}),e(P,{}),e(U,{}),e(J,{})]})}const V=z`
:root {
...
`;E.render(r(S.StrictMode,{children:[e(V,{}),e(Q,{})]}),document.getElementById("root"));
