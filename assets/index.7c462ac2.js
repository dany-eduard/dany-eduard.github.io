import{j as w,s as r,r as z,W as E,R as j,a as M}from"./vendor.ea0d32cb.js";const L=function(){const l=document.createElement("link").relList;if(l&&l.supports&&l.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))f(t);new MutationObserver(t=>{for(const a of t)if(a.type==="childList")for(const x of a.addedNodes)x.tagName==="LINK"&&x.rel==="modulepreload"&&f(x)}).observe(document,{childList:!0,subtree:!0});function s(t){const a={};return t.integrity&&(a.integrity=t.integrity),t.referrerpolicy&&(a.referrerPolicy=t.referrerpolicy),t.crossorigin==="use-credentials"?a.credentials="include":t.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function f(t){if(t.ep)return;t.ep=!0;const a=s(t);fetch(t.href,a)}};L();var T="assets/logo.e7ef0941.svg",k="assets/menu.31757ce1.svg",S="assets/close.69d19444.svg";const C=`
  width: 100%;
  height: 70px;
...
`;r.div``;function fe(){return o(de,{children:[e(me,{children:e(O,{})}),o(he,{children:[e(H,{}),e(U,{}),e(V,{}),e(K,{}),e(re,{})]}),e(pe,{children:e(ce,{})})]})}const xe=E`
:root {
